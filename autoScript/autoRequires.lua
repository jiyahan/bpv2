...
FollowHeroCmd = require 'lua.component.Cmd.FollowHeroCmd'
BeHit = require 'lua.component.BeHit'
RenderHitting = require 'lua.component.RenderHitting'
HitBack = require 'lua.component.HitBack'
