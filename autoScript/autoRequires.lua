...
CreateEntities = require 'lua.component.CreateEntities'
...
archetype = require 'lua.module.archetype'
LoadMap = require 'lua.component.scene.LoadMap'
panelStartMenu = require 'lua.panel.panelStartMenu'
panelPauseMenu = require 'lua.panel.panelPauseMenu'
brickMgr = require 'lua.module.entityMgr.brickMgr'
doorMgr = require 'lua.module.entityMgr.doorMgr'
sceneMgr = require 'lua.module.entityMgr.sceneMgr'
MapDoor = require 'lua.component.MapDoor'
heroMgr = require 'lua.module.entityMgr.heroMgr'
